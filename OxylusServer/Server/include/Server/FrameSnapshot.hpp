...
struct ViewRequest {
  ServerViewID view_id = ServerViewID::Invalid;
  ServerCameraSource source = ServerCameraSource::ClientSupplied;
...
struct ViewSnapshot {
  ServerViewID view_id = ServerViewID::Invalid;
  ServerCameraSource source = ServerCameraSource::Invalid;
  EntityHandle camera_entity = EntityHandle::Invalid;
