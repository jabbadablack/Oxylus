...
if(CMAKE_SYSTEM_NAME STREQUAL "Windows")
  set(_ox_slang_cmake_dir "${_ox_slang_prefix}/cmake")
else()
  set(_ox_slang_cmake_dir "${_ox_slang_prefix}/lib/cmake/slang")
endif()

if(NOT EXISTS "${_ox_slang_cmake_dir}/slangConfig.cmake")
